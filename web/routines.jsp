...
<html>
    ...
    <body>
        ...
        <div class="routinemid">
                    ...
                    <div class="cartitems">
                        ...
                        <c:forEach var="item" items="${sessionScope.cart}">
                            ...
                            <form class="checkoutcartform" method="GET" action="CustomerCart">
                                ...
                                <input name="url" type="hidden" value="routines.jsp">
            ...
            <div class="routines">
                <div class="bulkdiv">
                    <a href="bulkroutine.jsp"><img class="bulklogo" src="Assets/Images/bulk.png"></a><br>
                    <a class="bulkdivlink" href="bulkroutine.jsp">THE 4 WEEK BULK PROGRAM</a>
                </div><br>
                <div class="toneddiv">
                    <a href="tonedroutine.jsp"><img class="tonedlogo" src="Assets/Images/fm.png"></a><br>
