...
<%@page import="Model.PreWorkoutFilter"%>
...
<html>
    <head>
        ...
        <title>FIT.com - Shop Pre-Workout</title>
                        ...
                        <tr>
                            <td>
                                <form id="searchproductform" class="form-inline my-2 my-lg-0" action="CustomerProduct" method="GET">
                                    ...
                                    <input type="hidden" name="type" value="Pre Workout">
                            ...
                            <td>
                                &nbsp;&nbsp;<a class="filtershop filtershopactive" href="shoppre.jsp">Pre-Workout</a>
                            </td>
                            <td>
                ...
                <c:if test="${empty email}"><label class="logintoshop">Login to start shopping</label></c:if>
                    ...
                    <div class="adminallitemsdiv">
                            <%
                                ...
                                FilterProducts preFilter = new PreWorkoutFilter();
                                ArrayList<Product> pre = preFilter.filterProducts(products);
                                
                                for (Product product : pre)
                                {
                            %>
