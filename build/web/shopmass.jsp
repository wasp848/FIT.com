...
<html>
    <head>
        ...
        <title>FIT.com - Shop Mass Gainer</title>
                                   ...
                                   <c:set var="totalqty" value="0"></c:set>
                                    <c:forEach var="item" items="${sessionScope.cart}">
                                        ...
                                        <form class="checkoutcartform" method="GET" action="CustomerCart">
                                            ...
                                            <input name="url" type="hidden" value="shopmass.jsp">
                        ...
                        <tr>
                            <td>
                                <form id="searchproductform" class="form-inline my-2 my-lg-0" action="CustomerProduct" method="GET">
                                    ...
                                    <input type="hidden" name="type" value="Mass Gainer">
                            ...
                            <td>
                                &nbsp;&nbsp;<a class="filtershop filtershopactive" href="shopmass.jsp">Mass Gainer</a>
                            </td>
                            <td>
                ...
                <c:if test="${empty email}"><label class="logintoshop">Login to start shopping</label></c:if>
                    ...
                    <div class="adminallitemsdiv">
                            <%
                                ...
                                FilterProducts massFilter = new MassFilter();
                                ArrayList<Product> mass = massFilter.filterProducts(products);
                                
                                for (Product product : mass)
                                {
                            %>
                            ...
                            <input name="url" type="hidden" value="shoppre.jsp">
